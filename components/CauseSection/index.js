        ...
        <div className="row justify-content-center">
          <div className="col-lg-6">
            <div className="wpo-section-title">
              <span>Supporting Students in Ethiopia</span>
              <h2>Our Programs</h2>
              <p>
                We provide school supplies, uniforms, and support to students in
                Webe Wachile district, Ethiopia. Together, we are building
                classrooms and empowering futures.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="wpo-campaign-single">
                  <div className="wpo-campaign-item">
                    <div className="wpo-campaign-img">
                      <Image src={Cause.cImg} alt={Cause.cTitle} />
